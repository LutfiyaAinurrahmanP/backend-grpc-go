...
// Source: github.com/LutfiyaAinurrahmanP/backend-grpc-go/db/sqlc (interfaces: Store)
...
func (m *MockStore) UpdateEntries(arg0 context.Context, arg1 db.UpdateEntriesParams) error {
	m.ctrl.T.Helper()
